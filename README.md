...
| `templatePath`        | _(empty)_     | Template file path                                      |
...
| `colorMonth`          | _(empty)_     | Color for the month name in the header (e.g. `#569cd6`) |
| `colorYear`           | _(empty)_     | Color for the year number in the header                 |
| `colorWeekNumber`     | _(empty)_     | Color for the week numbers column                       |
| `colorDate`           | _(empty)_     | Color for the day numbers in the grid                   |
| `fontFamily`          | _(empty)_     | Font family for the calendar (e.g. `Georgia`)           |
...
# Install
code --install-extension extension_name-1.0.0.vsix
```
